...
{
    [DbContext(typeof(HorecaDbContext))]
    [Migration("20220608160703_ProductPicture")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Horeca.Models.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Horeca.Models.ProductBid", b =>
                {
                    ...
                    b.Property<int>("MaxPurchaseAmount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Horeca.Models.ProductPicture", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Horeca.Models.Category", b =>
                {
                    b.HasOne("Horeca.Models.Category", "Parent")
            ...
            modelBuilder.Entity("Horeca.Models.Order", b =>
                {
                    b.HasOne("Horeca.Models.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("Horeca.Models.OrderLine", b =>
                {
                    b.HasOne("Horeca.Models.Order", "Order")
                        .WithMany("Lines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Horeca.Models.ProductBid", "ProductBid")
                        .WithMany()
                        .HasForeignKey("ProductBidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProductBid");
                });

            modelBuilder.Entity("Horeca.Models.Product", b =>
                {
                    b.HasOne("Horeca.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Horeca.Models.ProductBid", b =>
                {
                    b.HasOne("Horeca.Models.Product", null)
